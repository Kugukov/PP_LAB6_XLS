package com.mycompany.kdk10_lab6_xls;
...
public class ReceiptExcel extends javax.swing.JFrame {
    ...
    private void modifData(String inputFileName, String outputFileName, String FIO, String Adress,
            String NDS, String SummUS) throws IOException {
        int sum = (Integer.parseInt(NDS) * Integer.parseInt(SummUS))/100 + Integer.parseInt(SummUS);
        ...
        sheet.getRow(10).getCell(3).setCellValue(FIO);
        sheet.getRow(11).getCell(3).setCellValue(Adress);
        sheet.getRow(12).getCell(3).setCellValue(NDS);
        sheet.getRow(12).getCell(8).setCellValue(SummUS);
        sheet.getRow(13).getCell(3).setCellValue(sum);
    ...
    private void initComponents() {
        ...
        jTextField_Adress.setBounds(150, 240, 550, 21);
        ...
        jTextField_SumPL.setBounds(150, 270, 50, 21);
        ...
        jTextField_SummUS.setBounds(460, 270, 60, 21);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\diamo\\Documents\\NetBeansProjects\\PP\\KDK10_LAB6_XLS\\src\\main\\java\\com\\mycompany\\kdk10_lab6_xls\\receipt2.png")); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(0, 0, 710, 370);
